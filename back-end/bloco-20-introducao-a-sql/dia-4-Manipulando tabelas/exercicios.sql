...
-- Exercício 1 Insira os filmes da Pixar abaixo na tabela Movies: Monstros SA,
-- de Pete Docter,
-- lançado em 2001,
-- com 92 minutos de duração.Procurando Nemo,
-- de John Lasseter,
-- lançado em 2003,
-- com 107 minutos de duração.Os Incríveis,
-- de Brad Bird,
-- lançado em 2004,
-- com 116 minutos de duração.WALL - E,
-- de Pete Docter,
-- lançada em 2008,
-- com 104 minutos de duração.
...
-- Exercício 4 O título do
--     filme "Ratatouille" está escrito de forma incorreta na tabela Movies,
--     além disso,
--     o filme foi lançado em 2007 e não em 2010. Corrija esses dados utilizando o
-- UPDATE.
