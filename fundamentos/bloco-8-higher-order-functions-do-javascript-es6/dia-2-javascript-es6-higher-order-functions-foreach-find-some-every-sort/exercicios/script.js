...
// 1 - Encontre o narrayome da primeira pessoa autora do livro nascida no ano de 1947.
...
function smallerName() {
  ...
  books.forEach((element) => nameBook = element.name.length < nameBook.length ? element.name : nameBook);
